...
NMS_MOD_DEFINITION_CONTAINER = 
{
  ...
  ["MOD_FILENAME"] 			= "OpenBiomeExtender-Core-BARRENBIOME.pak",     --the name of the pak created (if not combined) - REQUIRED
	...
	{
		{
			["MBIN_CHANGE_TABLE"] = 
			{
				{
					["MBIN_FILE_SOURCE"] = {
						{"METADATA/SIMULATION/SOLARSYSTEM/BIOMES/BARREN/BARRENBIOME.MBIN","OPENBE/BIOMEFILES/VANILLA/BARREN/BARRENBIOME.MBIN","REMOVE"},
					},
				},
				{
					["MBIN_FILE_SOURCE"] = {
