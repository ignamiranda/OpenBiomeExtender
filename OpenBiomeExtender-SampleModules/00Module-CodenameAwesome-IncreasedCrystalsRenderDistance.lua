...
NMS_MOD_DEFINITION_CONTAINER = 
{
  ...
  ["MOD_FILENAME"] 			= "zzCodenameAwesome-OpenBE-IncreasedCrystalsRenderDistance.pak",     --the name of the pak created (if not combined) - REQUIRED
  ["MOD_DESCRIPTION"]		= "Adds the chance for planets with bigger resource crystals to spawn, while still allowing some planets to have normal sized crystals",         --optional, for reference
