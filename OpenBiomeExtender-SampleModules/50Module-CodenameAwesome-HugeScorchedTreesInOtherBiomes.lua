...
NMS_MOD_DEFINITION_CONTAINER = 
{
  ...
  ["MOD_FILENAME"] 			= "zzCodenameAwesome-OpenBE-HugeScorchedTreesInOtherBiomes.pak",     --the name of the pak created (if not combined) - REQUIRED
  ["MOD_DESCRIPTION"]		= "Adds the DistantObjects of the HUGESCORCHBIOME to more biomes.",         --optional, for reference
