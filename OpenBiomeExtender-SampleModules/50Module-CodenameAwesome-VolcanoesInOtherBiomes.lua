...
NMS_MOD_DEFINITION_CONTAINER = 
{
  ...
  ["MOD_FILENAME"] 			= "zzCodenameAwesome-OpenBE-VolcanoesInOtherBiomes.pak",     --the name of the pak created (if not combined) - REQUIRED
  ["MOD_DESCRIPTION"]		= "Adds a chance for volcanoes to spawn in all biomes, although at a lower density than in the Lava biome.",         --optional, for reference
