...
NMS_MOD_DEFINITION_CONTAINER = 
{
  ...
  ["MOD_FILENAME"] 			= "zzCodenameAwesome-OpenBE-LavaScorchedBlend.pak",     --the name of the pak created (if not combined) - REQUIRED
  ["MOD_DESCRIPTION"]		= "Adds Lava objects to the Scorched biome and vice versa, while preserving the overall theme and uniqueness of the original biomes.",         --optional, for reference
	...
	{
		{
			...
			{ 
				{
					["MBIN_FILE_SOURCE"] 	= {"OPENBE/BIOMEFILES/SCORCHED/SCORCHEDBIOME.MBIN"},
					["EXML_CHANGE_TABLE"] = {
						{
...
[[        <Property value="NMSString0x80.xml">
          <Property name="Value" value="OPENBE/OBJECTFILES/VANILLA/DETAILOBJECTS/LAVA/LAVAOBJECTSFULL.MBIN" />
				...
				{
					["MBIN_FILE_SOURCE"] 	= {"OPENBE/BIOMEFILES/LAVA/LAVABIOME.MBIN"},
					["EXML_CHANGE_TABLE"] = 
					{
						{
							["SPECIAL_KEY_WORDS"] = {"Name","LANDMARKS"},
