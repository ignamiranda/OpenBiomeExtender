...
NMS_MOD_DEFINITION_CONTAINER = 
{
  ...
  ["MOD_FILENAME"] 			= "zzCodenameAwesome-OpenBE-CaveyMountains.pak",     --the name of the pak created (if not combined) - REQUIRED
  ["MOD_DESCRIPTION"]		= "Adds cave detailobjects to mountains",         --optional, for reference
