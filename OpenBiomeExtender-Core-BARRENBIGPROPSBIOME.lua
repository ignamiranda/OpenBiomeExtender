...
NMS_MOD_DEFINITION_CONTAINER = 
{
  ...
  ["MOD_FILENAME"] 			= "OpenBiomeExtender-Core-BARRENBIGPROPSBIOME.pak",     --the name of the pak created (if not combined) - REQUIRED
	...
	{
		{
			["MBIN_CHANGE_TABLE"] = 
			{
				{
					["MBIN_FILE_SOURCE"] = {
						{"METADATA/SIMULATION/SOLARSYSTEM/BIOMES/BARREN/BARRENBIGPROPSBIOME.MBIN","OPENBE/BIOMEFILES/BARREN/BARRENBIGPROPSBIOME.MBIN","REMOVE"}
					},
				},
				{
					["MBIN_FILE_SOURCE"] = {"OPENBE/BIOMEFILES/BARREN/BARRENBIGPROPSBIOME.MBIN"},
					["EXML_CHANGE_TABLE"] = 
					{
						{
