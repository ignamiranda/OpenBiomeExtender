...
NMS_MOD_DEFINITION_CONTAINER = 
{
  ...
  ["MOD_FILENAME"] 			= "OpenBiomeExtender-Core-TOXICBIOME.pak",     --the name of the pak created (if not combined) - REQUIRED
	...
	{
		{
			["MBIN_CHANGE_TABLE"] = 
			{
				{
					["MBIN_FILE_SOURCE"] = {
						{"METADATA/SIMULATION/SOLARSYSTEM/BIOMES/TOXIC/TOXICBIOME.MBIN","OPENBE/BIOMEFILES/VANILLA/TOXIC/TOXICBIOME.MBIN","REMOVE"}
					},
				},
				{
					["MBIN_FILE_SOURCE"] = {"OPENBE/BIOMEFILES/VANILLA/TOXIC/TOXICBIOME.MBIN"},
					["EXML_CHANGE_TABLE"] = 
					{
						{
